...
mkdir -p $protodir/local_testing/geo-inputs/$collection_id/
cd $protodir/local_testing/geo-inputs/$collection_id/
...
cd $protodir
cwltool \
    --outdir=./local_testing/geo-outputs/ \
    $protodir/workflows/viirsl1/tasks/geo-step.cwl \
    $protodir/local_testing/geo-inputs/$collection_id.yaml
