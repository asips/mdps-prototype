...
collection_id=CLDMSK_D3_VIIRS_NOAA20
...
mkdir -p $protodir/local_testing/mvcm_d3-inputs/$collection_id/
cd $protodir/local_testing/mvcm_d3-inputs/$collection_id/

rsync -av $protodir/local_testing/mvcm_g3-outputs/*/CLDMSK*.nc .
...
cd $protodir
cwltool \
    --outdir=./local_testing/mvcm_d3-outputs/ \
    $protodir/workflows/mvcm_l3/tasks/process_d3.cwl \
    $protodir/local_testing/mvcm_d3-inputs/$collection_id.yaml
